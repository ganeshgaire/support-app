...
import 'package:nctserviceapp/component/usersearchpage.dart';
import 'package:shared_preferences/shared_preferences.dart';

import 'package:http/http.dart' as http;

import '../model/allinformationmodel.dart';
import '../model/prioritylistmodel.dart';
...
class _CreateTaskState extends State<CreateTask> {
  ...
  String imagehinttext = "Select Image";
  ...
  final sucessmsg = const SnackBar(
    content: Text('sucessfully created Task'),
    duration: Duration(milliseconds: 500),
  );
  ...
  Future createTask() async {
    try {
      ...
      String url = baseurl + "tasks/create";
      var body = {
  ...
  void pickimageFromCamera() async {
    try {
      ...
      if (pickedFile != null) {
        ...
        setState(() {
          isShow = true;
          imagehinttext = "Image Uploaded(Tap To Add More Image)";
